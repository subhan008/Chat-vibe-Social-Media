...
console.log(searchInput,'555555');
    if(localUser){
      navigate('/')
    }
    else{   
  ...
  return (
    ...
    <div className="flex justify-between mt-5 overflow-auto "> 
     <div>
      ...
      <form action="">
         <input  className="w-48 h-10 border-2 border-stone-400 rounded-l-lg  " placeholder="Add comment" type="text"/>
         </form>
      ...
      <div className="posts w-96 h-72 bg-gray-50 mx-auto pt-16 ">
        <div className="ml-1">
        ...
        <div className="flex mt-3 ml-3">
                      ...
                      <p  className="font-semibold text-base float-left ml-4 mt-3 ">78 Likes</p>
                      <div className="flex mt-10 ml-4">  
                        <h1 className="font-medium text-justify">subhan<span className="ml-1 font-normal text-slate-600 ">
                          hello world
                          </span></h1>
                        <p >
