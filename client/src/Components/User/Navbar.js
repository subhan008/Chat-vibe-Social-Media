...
<svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className=" h-7 mr-5 cursor-pointer">       
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" onClick={()=>{navigate('/inbox')}} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-7 mr-4 cursor-pointer">
